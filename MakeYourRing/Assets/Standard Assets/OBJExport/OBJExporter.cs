...
public class OBJExporter
{
    ...
    public void Export(string exportPath, GameObject obj) //Added the public and the specific GameObject and many other things
    {
        try
        {
            //init stuff
            ...
            //No progress bar since it's Editor only
    ...
    string ExportTexture(Texture2D t)
    {
        try
        {
            //Doesn't understand why it is needed, but when added it's crash the build and it work without is sooo
            /*#if UNITY_EDITOR
